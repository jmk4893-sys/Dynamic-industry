...
CASES: tuple[Case, ...] = (
    ...
    Case("AI-06", "IR 가열 종점 최적화", "B", "엣지 추론 서버",
         ...
         "데크별 열이력 → 박리 성공 확률 모델. 장당 소성시간을 개별 최적화.",
    ...
    Case("AI-09", "라인 스케줄 강화학습", "C", "해당없음",
         ...
         "—",
         "—",
         "**권고하지 않는다.** 이 라인은 직렬이고 병목이 JBR-201 45 s 로 "
         "고정이라 최적해가 자명하다. 실제로 택트 48.47 s 는 병목에 "
         "8 s 를 더한 값이고, 그보다 빨라질 여지는 기구에 있지 스케줄에 "
         "없다. 학습 정책을 넣으면 검증·설명 부담만 는다."),
