...
STRUCTURES: tuple[Structure, ...] = (
    ...
    Structure("FRAMELESS", "frameless", "무프레임 (단면·유리·백시트)", False, "백시트",
              True, "PROCESS_NO_AFR",
              "클램프·정반 통과 — 인발 생략 (프레임 부재를 고장으로 치환하지 않는다). "
              "다만 **달라지는 곳은 AFR 이 아니라 투입부가 먼저다** — 프레임이 없으면 "
              "적층에서 유리면끼리 닿아 SEP-101 이 곧게 못 뗀다. 엣지 리프터로 모서리를 "
              "젖혀 크랙을 낸 뒤 이어 들어야 한다 (OI-08 · destack.py)",
