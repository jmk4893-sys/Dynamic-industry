...
FEEDERS: tuple[Feeder, ...] = (
    ...
    Feeder("F4", "LP-AFR", "HPU-601 7.5 kW · 장축 LM 캐리지 4축 · 반출롤러 인버터",
           11.5, 0.70, 32, "4C×10 mm² Cu", "GA 명시(HPU)"),
    # REV.51: 단변 횡행 헤드(스핀들 2.2 + 압력 0.4 + 횡행 0.4)와 GI-303 하부 라인스캔(0.2) 이
    # 더해져 9.0 → 12.2. 32 A · 6 mm² 는 그대로 — 12.2 kW 는 380 V 에서 20.6 A 다.
    Feeder("F5", "LP-GLASS", "SG-301 3헤드 연마(AFR 반출롤러 위) · CV-102 GI 통과 이송 · GI-301/302 통합 광학검사 · GI-303 하부 라인스캔",
           12.2, 0.70, 32, "4C×6 mm² Cu", "계획"),
