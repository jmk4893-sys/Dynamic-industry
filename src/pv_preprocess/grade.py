...
CRITERIA: tuple[Criterion, ...] = (
    ...
    Criterion("T-03", "기술", "성능률", 0.95, "", ">=",
              ...
              performance_rate,
              "REV.54: 병목은 DG-HK60C 유리제거기(52.56 s/장)이고 택트는 거기서 "
              "파생한 페이싱(55.08 s)이다 — 52.56/55.08 = 0.954. 성능률의 격차는 "
              "후단 능력(순생산 60.5 장/h)이 정하고, 그 위는 파일럿(칼날 속도)이나 "
              "트윈(DG-HK120C)으로만 닫힌다"),
    ...
    Criterion("D-02", "내구성", "소요 미상 예비품", 0, "종", "<=",
              ...
              spares_unknown,
              "칼날·연마휠은 run-at-rate, 뮤팅 센서는 벤더 B10d, 칼날 카세트는 "
              "파일럿 PT-02(OI-12), IR 램프는 DG-HK60C 벤더값 — 전부 받아야 채워진다"),
    Criterion("D-03", "내구성", "단일고장 정지 블록 비율", 0.0, "", "<=",
              ...
              "막으므로 적재 컬럼 3열이 서로를 받고 주행은 이중 구동이다"),
