...
DECKS = [("250 µm", "250 µm O/S — 조대 폴리머 → P3"),
         ("106 µm", "106~250 µm O/S → TC-01"),
         ("75 µm", "75~106 µm O/S → TC-01"),
         ("PAN", "< 75 µm — 실리콘+은 → P1")]

PART = [
    (1,  "피드 호퍼 · 상부 커버", "STS304 t3",           1),
    (2,  "스크린 프레임 (250 µm)", "STS304 / 메쉬 STS316", 1),
...
def ga_drawing():
    ...
    SHORT = {"d250": "250 O/S → P3", "d106": "106 O/S → TC-01",
             "d75": "75 O/S → TC-01", "pan": "PAN U/S → P1"}
    ...
    rows = [("250 O/S", "250~500 µm 조대 폴리머 — 구리 없음 → P3 백시트"),
            ("106 O/S", "106~250 µm → TC-01 분급기 (합류)"),
            ("75 O/S", "75~106 µm → TC-01 분급기 (합류)"),
...
def iso_drawing():
    ...
    dh = D["deck_h"] * S
    decks = [("250 µm 데크", "250 O/S → P3"), ("106 µm 데크", "106 O/S → TC-01"),
             ("75 µm 데크", "75 O/S → TC-01"), ("PAN (배출반)", "PAN U/S → P1")]
