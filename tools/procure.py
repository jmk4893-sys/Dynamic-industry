...
PLATE_STOCK = {
    ...
    "PC":      ((2050, 3050),),
    "GFRP":    ((1220, 2440),),
    "UHMW-PE": ((1000, 2000), (1220, 2440), (1000, 3000)),   # 긴 접촉면은 3,000 시트에서만 한 장으로 나온다
...
BUY_SPEC: dict[str, tuple[str, str, str, str]] = {
    ...
    "P-004-08": ("기계", "NBR 벨로우즈 패드 Ø250 · 내열 120 ℃", "G1/4 니플",
                 f"{PT.PAD_COLS * PT.PAD_ROWS}점 동일 평면 ≤ 0.3"),
    ...
    "P-005-24": ("기계", "스프링 포스트 · 예압 20 N · 행정 10", "M10 2", "예압 확인 · 간극 균일 ± 1"),
    # ── M-006
    "P-006-05": ("기계", "수동 트롤리 + 전동 호이스트 정격 250 kg · 인양 5 m",
...
SPARES = {
    ...
    "P-005-15": "SKD11 인서트 (중앙) 2개 — 먼저 무는 날이라 가장 먼저 닳는다",
    "P-005-16": "SKD11 인서트 (계단) 12개 (2벌)",
    "P-005-17": "카트리지 히터 (중앙) 1본",
    "P-005-18": "카트리지 히터 (계단) 2본",
